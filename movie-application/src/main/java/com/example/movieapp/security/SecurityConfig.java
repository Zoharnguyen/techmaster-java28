...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> {
            ...
            auth.requestMatchers("/", "/phim-bo", "/phim-chieu-rap", "/phim-le", "/tin-tuc", "/tin-tuc/**", "/phim/**", "/xem-phim/**", "/cua-hang", "/cua-hang/**", "/dang-nhap", "/dang-ky", "/quen-mat-khau", "/xac-thuc-tai-khoan", "/quoc-gia/**", "/the-loai/**").permitAll();
